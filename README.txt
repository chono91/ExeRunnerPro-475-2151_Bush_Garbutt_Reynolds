...
1) Determine what artifacts are left by any program when you install or run it. 
2) Search a computer for that artifacts to determine if and when a program was likely installed/run.
